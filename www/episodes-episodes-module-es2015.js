...
let EpisodesPage = EpisodesPage_1 = class EpisodesPage {
    ...
    initializeItems() {
        ...
        this.router.navigateByUrl(`/tabs/episodes/${EpisodesPage_1}`);
    }
    filterList(evt) {
...
EpisodesPage = EpisodesPage_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
