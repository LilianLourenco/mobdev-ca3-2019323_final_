  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        key: "searchQuote",
        value: function searchQuote(text) {
          return this.http.get("https://www.breakingbadapi.com/api/quote?author=".concat(text));
        }
      }, {
        key: "getDeaths",
        ...
        key: "searchDeath",
        value: function searchDeath(text) {
          return this.http.get("https://www.breakingbadapi.com/api/death-count?name=".concat(text));
        }
      }]);
